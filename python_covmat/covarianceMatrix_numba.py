...
def matcov(
		...
		layerHeights, r0, L0, data, gsMag, pupilOffset=None,
		wfsRot=None):
	"""
	...
	Parameters:
		...
		r0 (ndarray): The strength of each layer...in some units...?
